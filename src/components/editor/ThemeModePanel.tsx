...
// ABOUTME: Provides color pickers, spacing controls, radius/shadow settings
...
import { Palette, Ruler, Shapes, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <Input
          ...
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className="flex-1 font-mono text-sm rounded-theme-input"
          placeholder="#000000"
        />
      </div>
    </div>
