// ABOUTME: Grid team block variant displaying team members in a responsive grid layout
...
/**
 * Grid-based team section with responsive column layout
            ...
            <Card key={index} className="border-2 transition-shadow hover:shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                {member.image ? (
                  ...
                  <div className="mb-4 mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-primary/10 text-4xl font-bold text-primary">
