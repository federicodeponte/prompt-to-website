  ...
  blocks: [
    ...
    },
    {
      ...
      content: {
        ...
        columns: [
          {
            heading: 'Services',
            links: [
              { text: 'Brand Strategy', url: '/services/brand' },
              { text: 'Web Development', url: '/services/web' },
              { text: 'Mobile Apps', url: '/services/mobile' },
              { text: 'Digital Marketing', url: '/services/marketing' },
            ],
          },
          {
            heading: 'Company',
        ...
        social: [
          { platform: 'Twitter', url: 'https://twitter.com/creativestudio' },
          { platform: 'LinkedIn', url: 'https://linkedin.com/company/creativestudio' },
          { platform: 'GitHub', url: 'https://github.com/creativestudio' },
        ],
