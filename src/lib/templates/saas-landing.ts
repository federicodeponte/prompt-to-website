  ...
  blocks: [
    ...
    },
    {
      ...
      content: {
        ...
        description: 'Built with love by a remote team that uses ProjectFlow every day.',
        columns: [
          {
            heading: 'Product',
            links: [
        ...
        social: [
          { platform: 'Twitter', url: 'https://twitter.com/projectflow' },
          { platform: 'LinkedIn', url: 'https://linkedin.com/company/projectflow' },
          { platform: 'GitHub', url: 'https://github.com/projectflow' },
        ],
