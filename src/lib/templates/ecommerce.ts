  ...
  blocks: [
    ...
    },
    {
      ...
      content: {
        ...
        logos: [
          ...
          { name: 'Engadget', src: '/logos/engadget.svg' },
          { name: 'CNET', src: '/logos/cnet.svg' },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        columns: [
          {
            heading: 'Shop',
            links: [
              { text: 'Headphones', url: '/products/headphones' },
              { text: 'Accessories', url: '/products/accessories' },
              { text: 'Bundles', url: '/products/bundles' },
        ...
        social: [
          { platform: 'Twitter', url: 'https://twitter.com/audiopro' },
          { platform: 'LinkedIn', url: 'https://linkedin.com/company/audiopro' },
          { platform: 'Facebook', url: 'https://facebook.com/audiopro' },
        ],
