// ABOUTME: Signup page with Supabase authentication
// ABOUTME: Email/password registration with email confirmation
      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-base">
            Start building beautiful websites with AI in minutes
          </CardDescription>
        </CardHeader>
